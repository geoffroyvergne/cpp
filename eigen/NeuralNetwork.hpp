...
class NeuralNetwork {
    public:
        NeuralNetwork(std::vector<uint> topologyn Scalar learningRate = Scalar(0.005));
        ...
        */
        ...
        std::vector<RowVector*> neuronLayer; // stores the different layers of out network 
        ...
        std::vector<RowVector*> weights; // the connection weights itself 
        Scalar learningRate;
}
